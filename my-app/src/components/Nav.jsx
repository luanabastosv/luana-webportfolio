...
function Nav() {
  ...
  return (
    <div className="nav-content">
      <nav>
        {/* DESKTOP HEADER */}
        <section className="left-sec desktop-only">
          <div>
            <button
        ...
        <section className="right-sec desktop-only">
          <ColorSwitcher />
        </section>
        ...
        <div className={`mobile-nav-wrapper ${menuOpen ? "open" : ""}`}>
          ...
          {/* <button className="mobile-fab" onClick={() => setMenuOpen(!menuOpen)}>
            {menuOpen ? "×" : "☰"}
          </button> */}
          <button className="mobile-fab" onClick={() => setMenuOpen(!menuOpen)}>
            {menuOpen ? (
          ...
          <ul className="mobile-fab-menu">
            ...
            <li>
              <button
                ...
                onClick={(e) => handleNavClick(e, "/projects", "projects")}
              >
                <img src="/assets/images/projects-icon.svg" alt="Projects" />
                <p>Projects</p>
              </button>
            </li>
